...
from .models import InvTrfrReqHeader, InvTrfrReqRow
from .schemas_header import (
    InvTrfrReqHeaderCreate,
    InvTrfrReqHeaderRead,
    InvTrfrReqHeaderUpdate,
)
        ...
        *,
        ...
        try:
            ...
            for row in rows_schema:
                ...
                to_whse_obj = crud_whse.get(fk=row.whsecode)
                from_whse_obj = crud_whse.get(fk=row.whsecode2)
                ...
                db_row_obj = InvTrfrReqRow(**row.dict())
                db_row_obj.inv_qty = (
        ...
        db_obj = (
            ...
            .filter(
                and_(
                    ...
                    or_(from_date == "", cast(self.model.transdate, DATE) >= from_date),
...
crud_inv_trfr_req = CRUDInvTrfrReq(InvTrfrReqHeader)
