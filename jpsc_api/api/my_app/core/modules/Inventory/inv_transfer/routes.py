...
from .schemas_header import InvTrfrHeaderCreate, InvTrfrHeaderRead
from .schemas_row import InvTrfrRowCreate
from .cruds import crud_inv_trfr
...
@router.get("/", response_model=SuccessMessage[list[InvTrfrHeaderRead]])
async def get_all_inv_transfer(
    *,
