...
from sqlmodel import func, and_, or_, cast, DATE
...
from .models import InvReceiveHeader, InvReceiveRow
from .schemas_header import (
    InvReceiveHeaderCreate,
    InvReceiveHeaderRead,
    InvReceiveHeaderUpdate,
)
        ...
        *,
        ...
        try:
            ...
            for row in rows_schema:
                ...
                db_row_obj = InvReceiveRow(**row.dict())
                db_row_obj.inv_qty = (
...
crud_inv_rec = CRUDInvReceive(InvReceiveHeader)
