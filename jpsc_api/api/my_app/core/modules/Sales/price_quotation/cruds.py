...
class CRUDPriceQuotation(
    ...
    def get_all(
        ...
        *,
        ...
        branches = [
            x.branch_code for x in current_user.assigned_branch if x.is_assigned
        ]
            ...
            .filter(
                and_(
                    ...
                    or_(
                        and_(
                            branch == "",
                            self.model.dispatching_branch.in_(branches),
                        ),
                        self.model.dispatching_branch == branch,
                    ),
                ),
            )
    ...
    def get_all_by_customer_code(
        ...
        *,
        ...
        db_obj = (
            ...
            .filter(
                and_(
                    self.model.customer_code == custcode,
                    self.model.docstatus != DocstatusEnum.canceled.value,
                    or_(
                        from_date == "",
                        cast(self.model.transdate, DATE) >= from_date,
                    ),
        ...
        *,
        ...
        try:
            ...
            if schema.pq_status == 1:
                ...
                header_dict["docstatus"] = DocstatusEnum.closed.value
