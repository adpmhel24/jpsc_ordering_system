  ...
  void _onLoadItemGroups(
    ...
    try {
      ...
      if (!isAuthorized) {
        ...
        emit(state.copyWith(
            status: FetchingStatus.success, datas: itemGroupRepo.datas));
      }
