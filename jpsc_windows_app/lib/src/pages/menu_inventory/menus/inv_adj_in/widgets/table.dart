...
class InvAdjInTable extends StatefulWidget {
  const InvAdjInTable({
    Key? key,
  ...
  @override
  State<InvAdjInTable> createState() => _InvAdjInTableState();
}

class _InvAdjInTableState extends State<InvAdjInTable> {
  ...
  Widget build(BuildContext context) {
    return Card(
      child: BlocConsumer<InvAdjustmentInBloc, InvAdjustmentInBlocStates>(
        bloc: context.read<InvAdjustmentInBloc>()
          ..add(
            FilterInvAdjIn(
  ...
  SizedBox tableFooter(InvAdjustmentInBlocStates state) {
    return SizedBox(
