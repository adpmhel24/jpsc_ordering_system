...
class InvAdjustmentInFormBloc
    extends Bloc<InvAdjustmentInFormEvent, InvAdjustmentInFormState> {
  InvAdjustmentInRepo invAdjInRepo;
  InvAdjustmentInFormBloc(this.invAdjInRepo)
      : super(const InvAdjustmentInFormState()) {
    ...
    on<NewInvAdjustmentInSubmitted>(_onNewInvAdjustmentInSubmitted);
  }

  void _onTransdateChanged(
      TransdateChanged event, Emitter<InvAdjustmentInFormState> emit) {
  ...
  void _onBranchChanged(
      BranchChanged event, Emitter<InvAdjustmentInFormState> emit) {
  ...
  void _onRemarksChanged(
      RemarksChanged event, Emitter<InvAdjustmentInFormState> emit) {
  ...
  void _onAddRowItem(AddRowItem event, Emitter<InvAdjustmentInFormState> emit) {
  ...
  void _onDeleteRowItem(
      DeleteRowItem event, Emitter<InvAdjustmentInFormState> emit) {
    List<InventoryAdjustmentInRow> itemRows = [];
  ...
  void _onUpdateRowItem(
      UpdateRowItem event, Emitter<InvAdjustmentInFormState> emit) {
    List<InventoryAdjustmentInRow> itemRows = [];
  ...
  void _onNewInvAdjustmentInSubmitted(NewInvAdjustmentInSubmitted event,
      Emitter<InvAdjustmentInFormState> emit) async {
    ...
    try {
      String message = await invAdjInRepo.create(data);
      emit(
        state.copyWith(
