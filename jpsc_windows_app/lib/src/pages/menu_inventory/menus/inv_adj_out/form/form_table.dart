...
class InvAdjustmentOutRowsFormTable extends StatefulWidget {
  const InvAdjustmentOutRowsFormTable({
    Key? key,
  }) : super(key: key);

  @override
  State<InvAdjustmentOutRowsFormTable> createState() =>
      _InvAdjustmentOutRowsFormTableState();
}

class _InvAdjustmentOutRowsFormTableState
    extends State<InvAdjustmentOutRowsFormTable> {
  ...
  Widget build(BuildContext context) {
    return Card(
      child: BlocBuilder<InvAdjustmentOutFormBloc, InvAdjustmentOutFormState>(
  ...
  SizedBox tableFooter(InvAdjustmentOutFormState state) {
    return SizedBox(
