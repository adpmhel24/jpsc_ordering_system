...
part of 'inv_adj_in.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

InventoryAdjustmentInModel _$InventoryAdjustmentInModelFromJson(
    ...
    InventoryAdjustmentInModel(
      ...
      rows: (json['rows'] as List<dynamic>)
          .map((e) =>
              InventoryAdjustmentInRow.fromJson(e as Map<String, dynamic>))
          .toList(),
    )
...
Map<String, dynamic> _$InventoryAdjustmentInModelToJson(
        InventoryAdjustmentInModel instance) =>
    <String, dynamic>{
      'id': instance.id,
