...
InventoryAdjustmentOutHeader _$InventoryAdjustmentOutHeaderFromJson(
...
Map<String, dynamic> _$InventoryAdjustmentOutHeaderToJson(
        InventoryAdjustmentOutHeader instance) =>
    <String, dynamic>{
      'id': instance.id,
