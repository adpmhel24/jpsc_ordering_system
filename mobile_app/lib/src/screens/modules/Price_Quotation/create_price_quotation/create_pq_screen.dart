...
class CreatePriceQuotationScreen extends StatefulWidget {
  const CreatePriceQuotationScreen({Key? key}) : super(key: key);
  ...
  @override
  State<CreatePriceQuotationScreen> createState() =>
      _CreatePriceQuotationScreenState();
}

class _CreatePriceQuotationScreenState
    extends State<CreatePriceQuotationScreen> {
  @override
  Widget build(BuildContext buildContext) {
    return BlocProvider(
      create: (context) =>
          CreatePriceQuotationBloc(context.read<PriceQuotationRepo>()),
      child: BlocListener<CreatePriceQuotationBloc, CreateSalesOrderState>(
                ...
                onButtonPressed: (cntx) {
                  cntx.router.replace(
                    const MainScreenRoute(
                      children: [
                        CreatePriceQuotationScreenRoute(),
                      ],
                    ),
                  );
                },
              ...
              bottomNavigationBar: BottomNavigationBar(
                ...
                items: [
                  ...
                  BottomNavigationBarItem(
                    label: 'Carts',
                    icon: Badge(
                      badgeContent: BlocBuilder<CreatePriceQuotationBloc,
